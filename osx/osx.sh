...
sudo scutil --set ComputerName "ftato"
sudo scutil --set HostName "ftato"
sudo scutil --set LocalHostName "ftato"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "ftato"
...
sudo ln -s ~/.wallpapers/default.jpg /System/Library/CoreServices/DefaultDesktop.jpg
...
# Disable Sudden Motion Sensor (SMS) -- not useful for SSDs
sudo pmset -a sms 0
...
defaults write .GlobalPreferences com.apple.mouse.scaling -1 # disable mouse acceleration
...
# Enabled the automatic update check
...
# Enable Stealth Mode. Computer will not respond to ICMP ping requests or connection attempts from a closed TCP/UDP port.
...
# Turn off remote desktop access.
